...
export const WORD_LIST: WordData[] = [
    ...
    //     clue: "suspended bed",
    //     answer: "hammock",
    //     roots: [{ english: "suspended bed", languageName: "Taíno", languageWord: "hamaca" }],
    //     definition: "a hanging bed made of fabric or netting",
    //     explanation: "The word \"hammock\" comes from the Taíno word \"hamaca\", referring to the suspended sleeping nets used by the Indigenous peoples of the Caribbean. When Columbus and other Spanish explorers encountered these comfortable hanging beds, they adopted the word and brought the concept back to Europe, where it was quickly adopted by sailors.",
    //     partOfSpeech: "noun",
    // },
    // {
    //     clue: "gravel",
