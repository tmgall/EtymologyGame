...
const TermsOfService = () => {
  return (
    <div className="support">
      ...
      <p className="supportText" style={{ fontWeight: 700 }}>Effective Date: November 9, 2025</p>
      ...
      <p className="supportText">Lexicon stores non-personally identifiable data, such as user stats and play history, in your browser's localStorage. Users are responsible for safeguarding their browser or device to prevent unauthorized access. Lexicon also captures general anonymized data such as country of origin and latency for better player experience.</p>
